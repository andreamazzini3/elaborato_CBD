...
street_names = ["Roma", "Milano", "Torino", "Napoli", "Venezia", "Firenze", "Genova", "Bologna", "Verona", "Padova",
                "Trieste","Palermo", "Parma", "Catania", "Perugia", "Livorno", "Ravenna", "Modena", "Cagliari", "Ancona", "Bari",
                "Bergamo", "Brescia", "Como", "Ferrara", "Forlì", "Latina", "Lecce", "Lucca", "Mantova", "Massa", "Monza",
                "Novara", "Pisa", "Prato", "Ragusa", "Rimini", "Salerno", "Sassari", "Savona", "Siena", "Siracusa", "Taranto",
                "Terni", "Trapani", "Treviso", "Udine", "Varese", "Vercelli", "Vicenza", "Agrigento", "Alessandria", "Aosta", "Arezzo",
                "Ascoli", "Asti", "Avellino", "Belluno", "Benevento", "Biella", "Brindisi", "Caltanissetta", "Campobasso", "Caserta", "Cosenza",
                "Cremona", "Crotone", "Fermo", "Foggia", "Via Grosseto", "Via Imperia", "Isernia", "La Spezia", "L'Aquila", "Lodi", "Macerata",
                "Matera", "Oristano", "Pescara", "Pistoia", "Potenza", "Reggio", "Rovigo", "Sondrio", "Teramo", "Trento", "Vibo Valentia",
                "Viterbo", "Chiavari", "Olbia", "Grosio", "Eboli", "Castelnuovo", "Nola", "Gioia", "Gragnano", "Taormina", "Erice",
                "Augusta", "Tropea" ]
